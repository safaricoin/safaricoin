...
uint256 hashGenesisBlock("0xfce06132d8788b25423e35efb3522fd0c97da2b3b1cb8789dd472686a4c75688");
...
const string strMessageMagic = "SafariCoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal safaricoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SafariCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa42010c964479d0010a7779639de78d97003edb54e3264eef9b25910bf4ed90c");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "20th November 2013, EA Standard: Former Prime Minister Raila Odinga warns against boycotting ICC trials";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1384980463;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088497989;

        if (fTestNet)
        {
            block.nTime    = 1384971152;
            block.nNonce   = 386857388;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8ee29e71b112bb033e8cb96e042ba4959608ac619ade84f984c2d6dfaf95aca3"));
