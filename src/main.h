...
// for now, we leave the block size at 6.0 MB, meaning we support roughly 12000 transactions
// per block, which means about 200 tps
...
static const int64 MAX_MONEY = 65000000 * COIN; // maximum of 65 000 000 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 100 / 250; // 100 blocks found a day. Priority cutoff is 1 SFR day / 250 bytes.
    }
